...
export default function Donation() {
  ...
  // بررسی وضعیت آماده‌سازی پروفایل
  ...
  return (
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {!isProfileReady && (
          <div className={`rounded-3xl border-2 border-dashed p-8 mb-10 ${
            isDark 
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className={`text-base ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
                  ...
                  Your supporters will be able to send you USDC directly!
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className={`flex items-center gap-4 p-4 rounded-2xl ${
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    {hasUsername 
                      ? `Your username: @${profile.username} — Your public URL: /u/${profile.username}`
                      : 'Choose a unique username for your public donation page (e.g., /u/majid)'}
                  </p>
                </div>
                {!hasUsername && (
              ...
              <div className={`flex items-center gap-4 p-4 rounded-2xl ${
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    {hasWallet 
                      ? `Wallet connected: ${formatAddress(profile.wallet_address)}`
                      : 'Enter your Base network wallet address to receive USDC donations'}
                  </p>
                </div>
                {!hasWallet && (
                  <span className={`text-xs px-3 py-1 rounded-full ${
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              {isProfileReady && publicProfileUrl && (
                <button
        ...
        {/* ===== کارت پروفایل عمومی (وقتی آماده است) ===== */}
        {isProfileReady && (
          <div className={`rounded-3xl p-6 border mb-10 ${
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 w-full md:w-auto">
                <div className={`flex-1 md:flex-none px-4 py-3 rounded-2xl font-mono text-sm ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {/* Total Received */}
          <div className={`rounded-3xl p-6 border transition-all hover:scale-105 ${
            isDark ? 'bg-gray-900 border-gray-800' : 'bg-white border-blue-100'
          }`}>
          ...
          <div className={`rounded-3xl p-6 border transition-all hover:scale-105 ${
            ...
            {stats.topDonor ? (
              <>
                <p className={`text-3xl font-bold mb-1 ${isDark ? 'text-white' : 'text-gray-900'}`}>
                  {stats.topDonorAmount.toFixed(4)}
                </p>
              ...
              <>
                <p className={`text-3xl font-bold mb-1 ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                  0.00
                </p>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1">
              <input
                ...
                className={`w-full px-5 py-3 rounded-2xl border focus:outline-none transition-colors ${
                  isDark
        ...
        {filteredDonations.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredDonations.map((donation) => (
              <div
                key={donation.id}
                className={`rounded-3xl p-6 border transition-all hover:shadow-lg ${
                  isDark ? 'bg-gray-900 border-gray-800' : 'bg-white border-blue-100'
                }`}
              >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className={`text-2xl font-bold ${
                        ...
                        {parseFloat(donation.amount).toFixed(4)}
                      </p>
                      <p className={`text-xs ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                        USDC
                      </p>
