      ...
      <div className="max-w-5xl mx-auto p-6 pt-10">
        ...
        {payments.length === 0 ? (
          <div className="text-center py-20">
            ...
            <a 
              href="/" 
              className="inline-block mt-6 bg-blue-600 text-white px-8 py-4 rounded-2xl font-semibold hover:bg-blue-700"
            >
              ...
              >
                ...
                <div className="space-y-4 text-center">
                  ...
                  <p className={`text-3xl font-bold transition-colors duration-300 ${
                    ...
                    {p.amount} <span className="text-xl font-normal">USDC</span>
                  </p>
                    ...
                    {!p.paid ? (
                      ...
                      p.tx_hash && (
                        <button
                          ...
                          className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-3 rounded-2xl font-medium transition flex items-center justify-center gap-2"
                        >
                          🔗 View on Basescan
                        </button>
                      )
